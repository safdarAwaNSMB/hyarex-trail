  ...
  return (
    <div className="border-border-200 border-t py-6 @md:flex @md:items-start">
      <div className="shrink-0 @md:w-40 @md:pe-4">
        ...
        >
          {review?.review?.user_nickname}
        </Title>
        <Text className="text-xs text-gray-500 @md:text-sm">
          {dayjs(review?.review?.date).format('DD MMM, YYYY')}
        </Text>
      </div>
      <div className="w-full pt-4 @md:pt-1">
        <div className="-mx-0.5 mb-2.5 flex">
          ...
          {review?.review?.rating === 4 && (
            <>
              ...
              <PiStarFill className="w-4 fill-orange text-orange" />
              <PiStarFill className="w-4 fill-orange text-orange" />
              <PiStar className="w-4 fill-gray-300 text-gray-500" />
            </>
          )}
        ...
        <Text className="leading-[1.85]">{review?.review?.content}</Text>

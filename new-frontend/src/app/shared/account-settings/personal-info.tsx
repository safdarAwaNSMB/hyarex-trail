...
export default function PersonalInfoView() {
  ...
  const initialValues = {...userData, first_name : userData.firstname, last_name : userData.lastname}
  const onSubmit: SubmitHandler<PersonalInfoFormTypes> = async (data, e) => {
    e?.preventDefault();
    // toast.success(<Text as="b">Successfully added!</Text>);
    // console.log('Profile settings data ->', {
    //   ...data,
    // });
    await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/update-user`, data).then(res => {
      console.log(res);
      toast.success(<Text as="b">Details Updated!</Text>);
      signIn('credentials', {...res.data.user});
    }).catch(err => {
      console.log(err);
      toast.error('Cant Updated Details!')
    })

...
import WishlistProducts from '../checkout/wishlist-products';

type WishlistDrawerViewProps = {
    items: CartItem[];
    total: number;
...
export default function WishlistDrawerView({
    items,
    total,
    addItemToCart,
    removeItemFromCart,
    clearItemFromCart,
    setOpenDrawer,
}: WishlistDrawerViewProps) {
    const isWishlistEmpty = isEmpty(items);
    return (
        <div className="flex h-full w-full flex-col">
            <DrawerHeader
                heading="Wishlist Box"

        ...
        <div className="flex h-auto gap-4 @5xl:gap-6">
          <div>
            <div className="relative -top-1/3 aspect-square w-[110px] overflow-hidden rounded-full border-4 border-white bg-white shadow-profilePic @2xl:w-[130px] @5xl:-top-2/3 @5xl:w-[150px] md:border-[6px] 3xl:w-[200px]">
                ...
                <Image
                  src={session?.data?.userData?.avator !== "null" ? session?.data?.userData?.avator : "https://isomorphic-furyroad.s3.amazonaws.com/public/avatars-blur/avatar-11.webp"}
                  alt="profile-pic"
                  fill
                  priority
          ...
          <div className="pt-2.5">
            ...
            >
              {(session?.data?.userData?.firstname + " " + session?.data?.userData?.lastname) || 'User Name'}
            </Title>
            <Text className="text-xs text-gray-500 @3xl:text-sm 3xl:text-base">
              {session?.data?.userData?.email || 'yourmail@domain.com'}
            </Text>
